    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pos', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.event', verbose_name='Публикация')),
            ],
        ),
        migrations.CreateModel(
            name='Comments',
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.event', verbose_name='Публикация')),
            ],
            options={
